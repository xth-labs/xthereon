...
"""Verify that starting xthereon with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xthereon with -h for help text")
        ...
        self.log.info("Start xthereon with -version for version information")
        ...
        self.log.info("Start xthereond with -fakearg to make sure it does not start")
