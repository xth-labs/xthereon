...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " xthereon-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  xthereon-tx [options] <hex-tx> [commands]  Update hex-encoded xthereon transaction\n" +
            "or:     xthereon-tx [options] -create [commands]   Create hex-encoded xthereon transaction\n" +
            "\n";
