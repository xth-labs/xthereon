...
const char * const BITCOIN_CONF_FILENAME = "xthereon.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XThereon";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/XThereon";
#else
    // Unix-like
    return pathRet / ".xthereon";
#endif
#endif
}
