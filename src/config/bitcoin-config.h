...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The XThereon Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "XThereon Core"
...
#define PACKAGE_BUGREPORT "https://github.com/xthereon-project/xthereon/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "XThereon Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XThereon Core 0.21.4"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xthereon"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://xthereon.org/"
