...
static UniValue gethashespersec(const JSONRPCRequest& request)
{
    UniValue result(UniValue::VOBJ);
    result.pushKV("hashespersec", nHashesPerSec);
    return result;
}
    ...
    return RPCHelpMan{
        ...
        "\nEnable or disable CPU mining.\n",
        {
            {"generate", RPCArg::Type::BOOL, RPCArg::Optional::NO,
                "true to enable mining, false to disable."},
            {"genproclimit", RPCArg::Type::NUM, RPCArg::Optional::OMITTED,
                "Number of processors to use, -1 means unlimited."},
        },
...
static RPCHelpMan getgenerate()
{
    return RPCHelpMan{
        "getgenerate",
        "\nReturn whether mining is enabled.\n",
        {},
...
static bool GenerateBlock(ChainstateManager& chainman, CBlock& block, uint64_t& max_tries, unsigned int& extra_nonce, uint256& block_hash)
{
    ...
    while (max_tries > 0 && block.nNonce < std::numeric_limits<uint32_t>::max() && !CheckProofOfWork(block.GetPoWHash(), block.nBits, chainparams.GetConsensus()) && !ShutdownRequested()) {
      // --- XTHEREON: hash counter for gethashespersec ---
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated xthereon to."},
...
static RPCHelpMan generate()
{
    return RPCHelpMan{
        ...
        {
            {"nblocks", RPCArg::Type::NUM, RPCArg::Optional::NO, "Number of blocks to mine"},
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "Address to send the block reward to"},
            {"maxtries", RPCArg::Type::NUM, /* default */ "1000000", "Maximum attempts"},
        },
        RPCResult{
            RPCResult::Type::ARR, "", "Hashes of blocks generated",
            { {RPCResult::Type::STR_HEX, "", "blockhash"} }
        ...
        RPCExamples{
            HelpExampleCli("generate", "1 \"myaddress\"")
        },
        [&](const RPCHelpMan&, const JSONRPCRequest& request) -> UniValue
        {
            int nBlocks = request.params[0].get_int();
            std::string address = request.params[1].get_str();
            uint64_t maxtries = request.params.size() > 2 ?
                                request.params[2].get_int64() : 1000000;
            ...
            return generateBlocks(chainman, mempool, script, nBlocks, maxtries);
        }
    };
}
...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated xthereon to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ ToString(DEFAULT_MAX_TRIES), "How many iterations to try."},
                },
                RPCResult{
                    RPCResult::Type::ARR, "", "hashes of blocks generated",
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated xthereon to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated xthereon to."},
...
if (!Params().IsTestChain()) {
    // --- XTHEREON PATCH: allow solo mining even without peers or during IBD ---
    LogPrintf("XThereon: Solo mining mode enabled (peers/IBD checks bypassed)\n");
    // DO NOT throw. Continue execution.
}

// XTHEREON PATCH: Allow solo mining from block 0
//if (IsInitialBlockDownload()) {
//    LogPrintf("XThereon: Solo mining - bypassing IBD check in getblocktemplate\n");
//}
...
static const CRPCCommand commands[] =
{
    ...
    { "mining", "gethashespersec", &gethashespersec, {} },
    // Your added CPU mining RPCs
    ...
    // Generating (block immediate creation)
    ...
    // Classic Bitcoin-like generate (hidden)
