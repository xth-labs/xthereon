...
extern std::atomic<bool> g_fGenerateBitcoins;
...
RPCHelpMan setgenerate()
{
    return RPCHelpMan(
        "setgenerate",
        "Set mining on or off.",
        {
            {"generate", RPCArg::Type::BOOL, RPCArg::Optional::NO, "Enable mining"},
            {"genproclimit", RPCArg::Type::NUM, RPCArg::Optional::OMITTED, "Ignored (compatibility only)"}
        },
        RPCResults{},
        RPCExamples{
        ...
        [&](const RPCHelpMan&, const JSONRPCRequest& request) -> UniValue {
            ...
            g_fGenerateBitcoins.store(fGenerate);
