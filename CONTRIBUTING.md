Contributing to XThereon Core
============================

The XThereon Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the XThereon Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/xthereon-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to xthereon-qt
...
The following applies to code changes to the XThereon Core project (and related
projects such as libsecp256k1), and is not to be confused with overall XThereon
Network Protocol consensus changes.

Whether a pull request is merged into XThereon Core rests with the project merge
...
Patches that change XThereon consensus rules are considerably more involved than
...
Where a patch set proposes to change the XThereon consensus, it must have been
...
The project leader is the release manager for each XThereon Core release.
