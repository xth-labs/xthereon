XThereon Core version *0.15.1* is now available from:

  <https://download.xthereon.org/xthereon-0.15.1/>
...
A number of changes to the way XThereon Core deals with peer connections and invalid blocks
