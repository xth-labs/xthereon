# Support for Output Descriptors in XThereon Core

Since XThereon Core v0.17, there is support for Output Descriptors. This is a
...
existing XThereon Core wallets, a convenience function `combo` is
